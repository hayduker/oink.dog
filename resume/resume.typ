...
#custom-title("Experience")[
  ...
  #work-heading(
    ...
    - Maintained core text processing utilities and complex Thrax grammars compiled to OpenFst finite-state machines. Built a custom syntax highlighting VS Code extension for the grammar DSL and improved its compiler.
  ...
  #work-heading(
    ...
    - Debugged complex thread contention, memory leaks, and segmentation faults using Valgrind, GDB, and JProfiler.
  ...
  #work-heading(
    ...
    - Developed NLP prototypes using Python's NLTK for corpus cleanup, text normalization, and part-of-speech rescoring.
    - Maintained legacy C++ dictation servers, applying performance patches and managing deployments using Chef.
  ]
  #work-heading(
...
#custom-title("Skills")[
  #skills()[
    ...
    - *Systems & Runtimes:* Multi-threading, async, real-time audio, finite-state machines, FFI, compiler frontends, WebAssembly
